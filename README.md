...
<div style="width:100%; display: flex; justify-content: center; align-items: center;">
  <img src="./screenshots/DataSource.png" height="100px" alt="Choose data source" style="display:block;"/>
  <img src="./screenshots/NavigateToProfile.png"  height="85px" alt="Navigate to profile" style="display:block;"/> 
</div>
