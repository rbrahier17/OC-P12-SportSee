...
<div style="width:100%; display: flex; justify-content: center; align-items: center;">
  <img src="./screenshots/DataSource.png" height="300" alt="Choose data source" style="display:block; width:45%"/>
  <img src="./screenshots/NavigateToProfile.png" height="300" alt="Navigate to profile" style="display:block;width:45%;"/> 
</div>
