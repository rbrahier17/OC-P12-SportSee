...
<div style="width:100%; display: flex; justify-content: center; align-items: center;">
  <img src="./screenshots/DataSource.png" height="auto" alt="Choose data source" style="display:block; width:45%; object-fit: contain;"/>
  <img src="./screenshots/NavigateToProfile.png" height="auto" alt="Navigate to profile" style="display:block; width:45%; object-fit: contain;"/> 
</div>
